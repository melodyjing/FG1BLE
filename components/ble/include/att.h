...
#define ATT_EXCHANGE_MTU_REQ             0x02 //!< ATT Exchange MTU Request更换最大传输单元请求
...
#define ATT_READ_BLOB_RSP                0x0d //!< ATT Read Blob Response 读取多个请求
#define ATT_READ_MULTI_REQ               0x0e //!< ATT Read Multiple Request
#define ATT_READ_MULTI_RSP               0x0f //!< ATT Read Multiple Response
#define ATT_READ_BY_GRP_TYPE_REQ         0x10 //!< ATT Read By Group Type Request按数组类型请求读取
#define ATT_READ_BY_GRP_TYPE_RSP         0x11 //!< ATT Read By Group Type Response
#define ATT_WRITE_REQ                    0x12 //!< ATT Write Request 写入请求
#define ATT_WRITE_RSP                    0x13 //!< ATT Write Response 写入响应
#define ATT_PREPARE_WRITE_REQ            0x16 //!< ATT Prepare Write Request准备写入请求
#define ATT_PREPARE_WRITE_RSP            0x17 //!< ATT Prepare Write Response
#define ATT_EXECUTE_WRITE_REQ            0x18 //!< ATT Execute Write Request执行写入请求
