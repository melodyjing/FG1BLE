...
#define     MAX_NUM_LL_PRD_ADV_SYNC        2                     // for periodic adv listener对于定期ADV listener
...
// macro for bit operations 	//位操作宏定义
...
//LL packet type
#define	ADV_IND                                  0               //Connectable Undirected Event可连接的无向事件 
#define	ADV_DIRECT_IND                           1               //Connectable  Directed Event 可连接的定向事件
#define	ADV_NONCONN_IND                          2               //Non-connectable Undirected Event 不可连接的无向事件
#define	ADV_SCAN_REQ                             3
#define	ADV_AUX_SCAN_REQ                         3
#define	ADV_SCAN_RSP                             4
#define	ADV_CONN_REQ                             5
#define	ADV_AUX_CONN_REQ                         5
#define	ADV_SCAN_IND                             6	             //Scannable Undirected Event可扫描的无向事件
