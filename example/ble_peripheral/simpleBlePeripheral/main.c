...
void hal_low_power_io_init(void)
{
    ...
    hal_pwrmgr_RAM_retention(RET_SRAM0|RET_SRAM1|RET_SRAM2);		//启动保留所有SRAM输入参数
    hal_pwrmgr_RAM_retention_set();									//所有
...
static void hal_rfphy_init(void)
{
    ...
    //============config RF Frequency Offset射频频率偏移
